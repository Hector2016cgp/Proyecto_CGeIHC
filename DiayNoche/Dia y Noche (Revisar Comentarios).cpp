...
int main()
{
	...
	/* INICIO DEFINICION REEMPLAZAR ESTO
	
		std::vector<std::string> skyboxFaces;
	skyboxFaces.push_back("Textures/Skybox/sb_night_rt.tga");
	skyboxFaces.push_back("Textures/Skybox/sb_night_lf.tga");
	skyboxFaces.push_back("Textures/Skybox/sb_night_dn.tga");
	skyboxFaces.push_back("Textures/Skybox/sb_night_up.tga");
	skyboxFaces.push_back("Textures/Skybox/sb_night_ft.tga");
	skyboxFaces.push_back("Textures/Skybox/sb_night_bk.tga");

	skybox = Skybox(skyboxFaces);*/

	// DEFINICION DE LAS SKYBOXES DE DÍA Y NOCHE
	...
	float cycleSpeed = 0.2f;   // Velocidad del ciclo (ajústala según necesites)
	...
	while (!mainWindow.getShouldClose())
	{
		...
		// Configura la luz puntual para el sol (índice 0)
		if (isDaytime) {
